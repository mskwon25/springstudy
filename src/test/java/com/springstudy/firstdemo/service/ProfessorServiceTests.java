...
public class ProfessorServiceTests {
	...
	public void addAndGetProfessorTest() {
		Professor professor1 = new Professor(1, "김교수", "700819", "영어");
		Professor professor2 = new Professor(2, "황교수", "700603", "국어");
	...
	public void deleteProfessorTest() {
		Professor professor1 = new Professor(1, "김교수", "700819", "영어");
		Professor professor2 = new Professor(2, "황교수", "700603", "국어");
		Professor professor3 = new Professor(3, "최교수", "691004", "수학");
		...
		professorService.deleteProfessorById(2);
		assertThat(professorService.getAllProfessors().size(), is(2));
